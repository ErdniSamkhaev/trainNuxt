<template>
  ...
  .task-item:hover {
    @apply shadow-md; /* Базовая тень при наведении */
  }
  
  @media (hover: hover) {
    .task-item:hover {
      @apply shadow-lg bg-gray-100 dark:bg-gray-700; /* Увеличенная тень и изменение цвета фона */
    }
  }
  
  @media (hover: none) {
    .task-item:active {
      @apply shadow-lg scale-105; /* Тень и увеличение при нажатии на мобильных устройствах */
    }
  }
  </style>
